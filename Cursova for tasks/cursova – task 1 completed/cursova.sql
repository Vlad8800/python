...
ALTER TABLE Books 
MODIFY access_type ENUM('Тільки в читальній залі', 'У читальній залі і в дома');
ALTER TABLE IssuedBooks
MODIFY reading_place ENUM('Тільки в читальній залі', 'У читальній залі і в дома');
...
GRANT SELECT, INSERT, UPDATE, DELETE, CREATE, DROP, INDEX, ALTER, EXECUTE ON librarysystem.* TO 'operator'@'localhost';
CREATE USER 'authorized_user'@'localhost' IDENTIFIED BY 'password';
GRANT SELECT, EXECUTE, CREATE TEMPORARY TABLES ON librarysystem.* TO 'authorized_user'@'localhost';
CREATE USER 'guest'@'localhost' IDENTIFIED BY 'guest';
GRANT SELECT ON librarysystem.* TO 'guest'@'localhost';
