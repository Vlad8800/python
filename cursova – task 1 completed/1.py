...
def fetch_books(category=None, title_search=None, room_filter=None):
    ...
    cursor = conn.cursor()
    query = """
    SELECT b.book_id, b.title, b.category_id, b.access_type, b.quantity,
           IF(EXISTS (
...
def show_reader_window(reader_id):
    ...
    tk.Button(root, text="Оновити книги", command=lambda: [show_books(reader_id), show_returned_books_inline(reader_id, return_books_frame)], font=("Arial", 11)).pack(pady=10)
